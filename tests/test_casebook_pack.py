"""Regression checks for the zenith-dev-deps-deck casebook."""
...
from casebook.harness import assert_expected, zenith_dev_deps_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_dev_deps_deck_summary(), assert_expected())
