...
`zenith-dev-deps-deck` is centered on developer tools work in Rust. The technical target is: Build a Rust toolkit that studies deps behavior through capacity fixtures, with allocation and spill reports and explicit failure cases.
